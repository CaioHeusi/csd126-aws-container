...
# __generated__ by Terraform from "us-east-1_F6jLV06hD/5u5458415dhdfkmntkevul5rup"
...
# __generated__ by Terraform from "us-east-1_F6jLV06hD"
resource "aws_cognito_user_pool" "xpix" {
  alias_attributes           = null
  auto_verified_attributes   = ["email"]
  deletion_protection        = "ACTIVE"
  mfa_configuration          = "OFF"
  name                       = "User pool - ofrqvt"
